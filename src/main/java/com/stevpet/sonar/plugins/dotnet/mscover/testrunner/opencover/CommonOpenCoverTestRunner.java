...
public class CommonOpenCoverTestRunner implements OpenCoverTestRunner {
    ...
    public CommonOpenCoverTestRunner(OpenCoverCommand openCoverCommand,
	...
	public CommonOpenCoverTestRunner() {
		super();
	}
