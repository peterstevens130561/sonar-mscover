 ...
 * report file.
 */
public class IntegrationTestCoverageDecorator extends CoverageDecorator {

  public IntegrationTestCoverageDecorator(Settings settings,TimeMachine timeMachine) {
