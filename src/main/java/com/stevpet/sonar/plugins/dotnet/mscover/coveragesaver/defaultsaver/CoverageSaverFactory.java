...
public class CoverageSaverFactory implements CoverageSaver {

    private final static Logger LOG = LoggerFactory.getLogger(CoverageSaverFactory.class);
    private BranchFileCoverageSaver branchCoverageSaver;
    private LineFileCoverageSaver lineCoverageSaver;
    private MicrosoftWindowsEnvironment microsoftWindowsEnvironment;

    public CoverageSaverFactory(
    ...
    public static CoverageSaver  createVsTest(
			MicrosoftWindowsEnvironment microsoftWindowsEnvironment,
			PathResolver pathResolver, FileSystem fileSystem) {
		return new CoverageSaverFactory(new NullBranchFileCoverageSaver(),
