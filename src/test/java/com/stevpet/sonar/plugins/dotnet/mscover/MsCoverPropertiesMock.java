...
public class MsCoverPropertiesMock {
    ...
    /**
     * @param solutionName - to return when getSolutionName is used
     */
    public void givenSolutionName(String solutionName) {
        when(properties.getSolutionName()).thenReturn(solutionName);
    }

    public void givenVisualStudioUnitTestPattern(String pattern) {
        when(properties.getVisualStudioUnitTestPattern()).thenReturn(pattern);
    }
 }
