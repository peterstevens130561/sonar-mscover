...
public class PropertiesTest {
    ...
    public void mwicProcessHas40Properties() {
        ProcessProperties properties=processes.get(0);
    ...
    public void checkFirstPropertyForExistence() {
        ProcessProperties properties=processes.get(0);
        String commandLine=properties.getCommandLine();
    ...
    public void checkProcessId() {
        ProcessProperties properties=processes.get(0);
        String processId=properties.getProcessId();
    ...
    public void checkParentProcessId() {
        ProcessProperties properties = processes.get(0);
        String parentProcessId = properties.getParentProcessId();
